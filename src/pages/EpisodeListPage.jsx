        ...
        <main className="dashboard-main" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ maxWidth: '600px', width: '100%', padding: '0 24px' }}>
            ...
            <p style={{
              ...
              {decodedCompanyName}에 새로운 경험을 등록하세요
            </p>
    ...
    <div className="dashboard-layout">
      ...
      <main className="dashboard-main">
        <div className="dashboard-header">
          ...
          <p className="dashboard-subtitle">저장된 경험 에피소드 목록</p>
        </div>
          ...
          <div className="dashboard-loading">
            <div style={{
              ...
              <svg width="80" height="80" viewBox="0 0 200 200">
                <defs>
                  <linearGradient id="epLoadingGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#9CA3AF" stopOpacity="0.3"/>
                    <stop offset="100%" stopColor="#6B7280" stopOpacity="0.3"/>
                  </linearGradient>
                </defs>
                <circle cx="100" cy="100" r="80" fill="url(#epLoadingGradient)" stroke="rgba(107, 114, 128, 0.5)" strokeWidth="2"/>
          ...
          <div className="project-grid">
            ...
            >
              <div style={{
                ...
                <span style={{ color: '#86868B', fontSize: '15px', fontWeight: '500' }}>에피소드 추가하기</span>
              </div>
            </div>
            ...
            {episodes.map((episode) => (
              <div
                ...
                onClick={() => navigate(`/database/${companyName}/episodes/${episode.id}`)}
                style={{ cursor: 'pointer' }}
              >
                <div className="project-card-header">
                  <h3 className="project-title">{episode.title || episode.category?.topic || '제목 없음'}</h3>
                </div>
                ...
                <p style={{ 
                  ...
                  {episode.contentText?.substring(0, 100) || '내용 없음'}...
                </p>
